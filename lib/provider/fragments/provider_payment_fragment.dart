      ...
      body: RefreshIndicator(
        ...
        child: Stack(
          children: [
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    (paymentDataList[index].paymentMethod.validate().isNotEmpty ? paymentDataList[index].paymentMethod.validate() : languages!.notAvailable).capitalizeFirstLetter(),
                                    style: boldTextStyle(),
                                  ),
                                ],
                              ).paddingSymmetric(vertical: 4),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  if (paymentDataList[index].isPackageBooking)
                                    PriceWidget(
                                      price: paymentDataList[index].packageData!.price.validate(),
                                      color: primaryColor,
                                      size: 16,
                                      isBoldText: true,
                                    )
                                    ...
                                    PriceWidget(
                                      price: calculateTotalAmount(
                                        ...
                                        extraCharges: paymentDataList[index].extraCharges,
                                      ),
                                      color: primaryColor,
                                      size: 16,
                                      isBoldText: true,
            ...
            Observer(
              builder: (_) => BackgroundComponent(
                text: languages!.lblNoTransactionFound,
                subTitle: languages!.lblSubTitleNoTransaction,
              ).visible(!appStore.isLoading && paymentDataList.isEmpty && isApiCalled),
            ),
