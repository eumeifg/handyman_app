...
import 'package:sun3ah_provider/auth/change_password_screen.dart';
import 'package:sun3ah_provider/auth/edit_profile_screen.dart';
...
import 'package:sun3ah_provider/components/theme_selection_dailog.dart';
...
import 'package:sun3ah_provider/provider/blog/view/blog_list_screen.dart';
import 'package:sun3ah_provider/provider/handyman_list_screen.dart';
import 'package:sun3ah_provider/provider/jobRequest/bid_list_screen.dart';
import 'package:sun3ah_provider/provider/packages/package_list_screen.dart';
import 'package:sun3ah_provider/provider/service_address/service_addresses_screen.dart';
import 'package:sun3ah_provider/provider/services/service_list_screen.dart';
import 'package:sun3ah_provider/provider/subscription/subscription_history_screen.dart';
import 'package:sun3ah_provider/provider/taxes/taxes_screen.dart';
import 'package:sun3ah_provider/provider/timeSlots/my_time_slots_screen.dart';
import 'package:sun3ah_provider/provider/wallet/wallet_history_screen.dart';
import 'package:sun3ah_provider/screens/about_us_screen.dart';
import 'package:sun3ah_provider/screens/languages_screen.dart';
import 'package:sun3ah_provider/screens/verify_provider_screen.dart';
        ...
        builder: (_) => SingleChildScrollView(
          child: Column(
            children: [
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Text(languages!.lblCurrentPlan, style: boldTextStyle(color: appStore.isDarkMode ? white : gray)),
                              Text(languages!.lblValidTill, style: boldTextStyle(color: appStore.isDarkMode ? white : gray)),
                            ],
                          ),
                          16.height,
                          Row(
                ...
                child: Column(
                  children: [
                    ...
                    if (appStore.userType != USER_TYPE_HANDYMAN)
                      SettingItemWidget(
                        leading: Image.asset(ic_document, height: 18, width: 18, color: appStore.isDarkMode ? white : gray.withOpacity(0.8)),
                    ...
                    if (appStore.userType != USER_TYPE_HANDYMAN) Divider(height: 0, thickness: 1, indent: 15.0, endIndent: 15.0),
                    if (appStore.userType != USER_TYPE_HANDYMAN)
                      SettingItemWidget(
                        leading: Image.asset(services, height: 18, width: 18, color: appStore.isDarkMode ? white : gray.withOpacity(0.8)),
                        title: 'Blogs', // Translate the String...
                        trailing: Icon(Icons.chevron_right, color: appStore.isDarkMode ? white : gray.withOpacity(0.8), size: 24),
                        onTap: () {
                    ...
                    Divider(height: 0, thickness: 1, indent: 15.0, endIndent: 15.0),
                    SettingItemWidget(
                      leading: Image.asset(ic_time_slots, height: 18, width: 18, color: appStore.isDarkMode ? white : gray.withOpacity(0.8)),
                    ...
                    Divider(height: 0, thickness: 1, indent: 15.0, endIndent: 15.0),
                    SettingItemWidget(
                      leading: Image.asset(servicesAddress, width: 18, color: appStore.isDarkMode ? white : gray.withOpacity(0.8)),
                    ...
                    Divider(height: 0, indent: 16, endIndent: 16).visible(appStore.isLoggedIn),
                    SettingItemWidget(
                    ...
                    SettingItemWidget(
                      ...
                      title: languages!.lblPurchaseCode,
                      trailing: Icon(Icons.chevron_right, color: appStore.isDarkMode ? white : gray.withOpacity(0.8), size: 24),
                      onTap: () {
              ...
              16.height,
              TextButton(
                child: Text(languages!.logout, style: boldTextStyle(color: primaryColor, size: 18)),
                onPressed: () {
                  appStore.setLoading(false);
                  logout(context);
                },
