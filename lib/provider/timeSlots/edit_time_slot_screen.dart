...
import 'package:sun3ah_provider/provider/timeSlots/components/available_slots_component.dart';
import 'package:sun3ah_provider/provider/timeSlots/components/days_bottom_sheet.dart';
        ...
        children: [
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(languages!.selectYourDay, style: boldTextStyle(size: 20)).paddingSymmetric(horizontal: 16, vertical: 16),
                HorizontalList(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          data.validate(),
                          style: boldTextStyle(color: isSelected ? white : appTextPrimaryColor),
                        ),
                      ),
                    );
                  },
                ...
                Row(
                  ...
                  children: [
                    Text(languages!.chooseTime, style: boldTextStyle(size: 20)),
                    TextButton(
