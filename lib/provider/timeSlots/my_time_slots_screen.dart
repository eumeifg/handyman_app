...
import 'package:sun3ah_provider/provider/timeSlots/components/days_component.dart';
import 'package:sun3ah_provider/provider/timeSlots/components/disclaimer_widget.dart';
import 'package:sun3ah_provider/provider/timeSlots/components/slot_component.dart';
import 'package:sun3ah_provider/provider/timeSlots/edit_time_slot_screen.dart';
import 'package:sun3ah_provider/provider/timeSlots/models/slot_data.dart';
import 'package:sun3ah_provider/provider/timeSlots/services/time_slot_services.dart';
...
class _MyTimeSlotsScreenState extends State<MyTimeSlotsScreen> {
  ...
  Widget build(BuildContext context) {
    List<String> temp = timeSlotsList.isNotEmpty ? timeSlotsList.firstWhere((element) => element.day!.toLowerCase() == selectedDay.toLowerCase(), orElse: () => SlotData(slot: [], day: '')).slot.validate() : [];
          ...
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                SlotsComponent(timeSlotList: temp).paddingOnly(left: 16, right: 16, top: 16),
                32.height,
                DisclaimerWidget(),
              ],
            ),
