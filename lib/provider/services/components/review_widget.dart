              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (showServiceName) Text('${languages!.lblService}: ${data.serviceName.validate()}', style: primaryTextStyle(size: 14), maxLines: 1, overflow: TextOverflow.ellipsis).paddingTop(8),
