          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text(languages!.lblAddServiceAddress, style: boldTextStyle(color: white), textAlign: TextAlign.justify),
                  IconButton(
                    onPressed: () {
                      finish(context);
                      appStore.setLoading(false);
          ...
          children: [
            ...
            Observer(builder: (_) {
              return BackgroundComponent(
                text: languages!.noServiceAddressTitle,
                subTitle: languages!.noServiceAddressSubTitle,
              ).visible(!appStore.isLoading && serviceAddressList.isEmpty);
            }),
