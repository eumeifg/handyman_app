...
import 'package:sun3ah_provider/components/disabled_rating_bar_widget.dart';
import 'package:sun3ah_provider/components/image_border_component.dart';
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              4.height,
                              Marquee(child: Text('data.handymanData!.designation.validate()', style: secondaryTextStyle(size: 12,weight: FontWeight.bold))),
                              4.height,
                            ],
                          ),
                          ...
                          if (data.handymanData!.createdAt != null)
                            Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(languages!.lblMemberSince, style: secondaryTextStyle(size: 12,weight: FontWeight.bold)),
                                Text(" ${DateTime.parse(data.handymanData!.createdAt.validate()).year}", style: secondaryTextStyle(size: 12,weight: FontWeight.bold)),
                              ],
                            ),
                          10.height,
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        BackWidget(),
                        16.width,
                        Text(languages!.lblAboutHandyman, style: boldTextStyle(color: Colors.white, size: 20)),
                      ],
                    ),
                  ),
