...
import 'package:sun3ah_provider/auth/component/user_demo_mode_screen.dart';
import 'package:sun3ah_provider/auth/forgot_password_dialog.dart';
import 'package:sun3ah_provider/auth/sign_up_screen.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Widget _buildTopWidget() {
    return Column(
      children: [
        32.height,
        Text(languages!.lblLoginTitle, style: boldTextStyle(size: 22)).center(),
        16.height,
        Text(
