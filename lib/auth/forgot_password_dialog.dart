                  ...
                  Container(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(languages!.forgotPasswordTitleTxt, style: primaryTextStyle(color: primaryColor).copyWith(height: 1.5)),
                          24.height,
                          AppTextField(
                            ...
                            decoration: inputDecoration(context, hint: languages!.hintEmail, fillColor: context.cardColor),
                            onFieldSubmitted: (s) {
                              forgotPwd();
                            },
                          ),
