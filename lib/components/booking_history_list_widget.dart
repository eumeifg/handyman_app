...
import 'package:sun3ah_provider/utils/dashed_rect.dart';
      ...
      children: <Widget>[
        ...
        Column(
          ...
          children: <Widget>[
            ...
            SizedBox(
              height: 65,
              child: DashedRect(gap: 3, color: data.activityType.validate().getBookingActivityStatusColor, strokeWidth: 1.5),
