...
import 'package:sun3ah_provider/components/my_provider_widget.dart';
...
import 'package:sun3ah_provider/handyman/screen/fragments/handyman_fragment.dart';
import 'package:sun3ah_provider/handyman/screen/fragments/handyman_profile_fragment.dart';
...
class _HandymanDashboardScreenState extends State<HandymanDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBarWidget(
        [
          languages!.lblHandymanDashboard,
          ...
          child: NavigationBar(
            ...
            destinations: [
              NavigationDestination(
                ...
                label: languages!.lblHandymanDashboard,
              ),
              NavigationDestination(
