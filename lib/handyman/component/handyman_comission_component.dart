          ...
          Column(
            ...
            children: [
              RichTextWidget(
                ...
                list: [
                  TextSpan(text: "${languages!.lblHandymanType}: ", style: secondaryTextStyle(size: 14)),
              ...
              RichTextWidget(
                ...
                list: [
                  ...
                  TextSpan(text: isCommissionTypePercent(commission.type) ? '${commission.commission.validate()}%' : '${getStringAsync(CURRENCY_COUNTRY_SYMBOL)}${commission.commission.validate()}', style: boldTextStyle(size: 14)),
