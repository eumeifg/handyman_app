          ...
          Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(total.validate(), style: boldTextStyle(color: Colors.white, size: 20)),
                  Container(
              ...
              8.height,
              Text(title.validate(), style: secondaryTextStyle(size: 12, color: appStore.isDarkMode ? Colors.white : context.cardColor)),
            ],
          ).expand(),
        ],
      ),
